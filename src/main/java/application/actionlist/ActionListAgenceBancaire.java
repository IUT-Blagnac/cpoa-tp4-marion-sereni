...
public class ActionListAgenceBancaire implements ActionList{
	...
	public ActionListAgenceBancaire(String m, String c, String t, ArrayList <Action> listActions){
		this.message=m;
		this.code=c;
		this.titre=t;
		...
		while (continuer) {
			...
			switch (choix) {
				...
				try {
					...
					break;
				case "3" :
					this.listeDesActions.get(2).execute(ag);
					break;
				case "4" :
					this.listeDesActions.get(3).execute(ag);
					break;
				default :
